...
public class SuggestFriendAdapter extends RecyclerView.Adapter<SuggestFriendAdapter.ViewHolder> {
    ...
    public SuggestFriendAdapter(Context mContext, com.example.project_fakebook.listeners.onClickListener onClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        init();
        if (userInfos.get(position).getAvatar() == null || userInfos.get(position).getAvatar().isEmpty()) {
            Glide.with(mContext)
                    .asBitmap()
            ...
            Glide.with(mContext)
                    .asBitmap()
                    .load(Constants.KEY_API + "/storage/" + userInfos.get(position).getAvatar())
                    .into(holder.profileUserImageComment);
        }


        holder.txtNameUser.setText(userInfos.get(position).getFirstName() + " " + userInfos.get(position).getLastName());
